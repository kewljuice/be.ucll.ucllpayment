...
function ucllpayment_civicrm_managed(&$entities) {
  $entities[] = [
    ...
    'params' => [
      ...
      'url_site_default' => 'https://papi.ucll.be/pay/item',
      'url_api_default' => 'https://pay.ucll.be/item/hash/',
      'url_site_test_default' => 'https://papi.ucll.be/pay/item',
      'url_api_test_default' => 'https://pay.ucll.be/item/hash/',
      'billing_mode' => 4,
      'is_recur' => 0,
      'payment_type' => 1,
    ],
